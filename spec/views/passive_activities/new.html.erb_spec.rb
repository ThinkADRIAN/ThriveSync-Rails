...
RSpec.describe "passive_activities/new", type: :view do
  before(:each) do
    assign(:passive_activity, PassiveActivity.new(
  ...
  it "renders new passive_activity form" do
    render

    assert_select "form[action=?][method=?]", passive_activities_path, "post" do
