...
RSpec.describe "passive_data_points/new", type: :view do
  before(:each) do
    assign(:passive_data_point, PassiveDataPoint.new(
      :user_id => "MyString",
      :integer => "MyString",
  ...
  it "renders new passive_data_point form" do
    render

    assert_select "form[action=?][method=?]", passive_data_points_path, "post" do
